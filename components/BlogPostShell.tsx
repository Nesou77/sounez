      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_280px]">
        ...
        <article>
          ...
          <aside className="my-8 rounded-2xl border border-border bg-muted/30 p-5">
            <h2 className="text-base font-bold">Before you use this guide</h2>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              Use the advice here as a practical starting point, then adapt it to your own site,
              audience, file, or platform. Check important details yourself, especially prices,
              legal claims, school requirements, accessibility text, and anything generated by AI.
            </p>
          </aside>
