...
const BLOG_POSTS_RAW: BlogPost[] = [
  ...
  },
  {
    ...
    metaTitle: "Best Free AI Tools for Creators, Students and Small Businesses",
    metaDescription:
  ...
  { slug: "how-to-create-a-strong-password", title: "How to Create a Strong Password You'll Actually Remember", excerpt: "Stop reusing passwords. Here's a simple system for strong, memorable credentials.", readTime: "7 min", image: "/blog/how-to-create-a-strong-password.webp", publishedAt: "2025-04-25", metaTitle: "How to Create a Strong Password You'll Actually Remember | Sounez", metaDescription: "Stop reusing passwords. A modern system using generators, password managers, and 2FA to protect every account â€” including a free password generator.", tags: ["security", "passwords", "productivity"] },
  ...
  { slug: "free-design-tools-for-web-creators", title: "Free Design Tools for Non-Designers and Web Creators", excerpt: "11 free browser tools covering color palettes, CSS gradients, favicons, typography, shadows, image compression, and more.", readTime: "9 min", image: "/blog/free-design-tools-for-web-creators.webp", publishedAt: "2025-08-20", updatedAt: "2026-06-27", metaTitle: "Free Design Tools for Non-Designers and Web Creators | Sounez", metaDescription: "11 free browser tools for non-designers and web creators: color palettes, CSS gradients, favicons, font pairings, box shadows, image compression, placeholders and patterns.", tags: ["design", "web", "tools", "non-designers"] },
];
