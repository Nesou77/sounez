...
const BLOG_POSTS_RAW: BlogPost[] = [
  ...
  { slug: "how-to-grow-on-tiktok", title: "How to Grow on TikTok in 2026: A Creator's Playbook", excerpt: "A practical, no-fluff guide to growing a real TikTok audience this year.", readTime: "8 min", image: "/blog/how-to-grow-on-tiktok.webp" },
  { slug: "how-to-compress-images", title: "How to Compress Images Without Losing Quality", excerpt: "Smaller files load faster and rank better. Here's exactly how to compress images the right way.", readTime: "5 min", image: "/blog/how-to-compress-images.webp" },
  ...
  { slug: "how-to-use-qr-codes-for-marketing", title: "How to Use QR Codes for Marketing (Without Looking Cheap)", excerpt: "QR codes are everywhere again. Here's how to use them in a way that actually works.", readTime: "5 min", image: "/blog/how-to-use-qr-codes-for-marketing.webp" },
  ...
  { slug: "how-to-write-youtube-descriptions", title: "How to Write YouTube Descriptions That Actually Get Views", excerpt: "Most creators ignore the description box. That's a mistake. Here's how to fix it.", readTime: "6 min", image: "/blog/how-to-write-youtube-descriptions.webp" },
  { slug: "css-gradients-guide", title: "The Complete Guide to CSS Gradients in 2026", excerpt: "Linear, radial, conic. Everything you need to build beautiful gradients with clean code.", readTime: "8 min", image: "/blog/css-gradients-guide.webp" },
  ...
  { slug: "image-seo-guide", title: "Image SEO: The Complete Guide to Ranking Your Images on Google", excerpt: "Alt text, file names, compression, structured data. Everything that makes images rank.", readTime: "6 min", image: "/blog/image-seo-guide.webp" },
