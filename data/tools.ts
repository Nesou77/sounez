...
export const TOOLS: Tool[] = [
  ...
  { slug: "word-counter", name: "Word Counter", description: "Paste your text and see word count, character count, sentence count and reading time right away.", category: "utility-tools", emoji: "📝", keywords: ["word counter", "character counter", "reading time"] },
  ...
  { slug: "image-compressor", name: "Image Compressor", description: "Compress JPG, PNG and WebP images free in your browser. Batch compress up to 20 files, convert formats, resize, and download as ZIP. Nothing is uploaded.", category: "utility-tools", emoji: "🖼️", keywords: ["image compressor", "compress image", "reduce image size", "compress jpg", "compress png", "compress webp", "photo compressor"], featured: true },
  ...
  { slug: "calculator", name: "Calculator", description: "A clean, fast calculator for everyday maths. Handles basic operations, percentages and square roots.", category: "utility-tools", emoji: "🧮", keywords: ["calculator", "online calculator", "free calculator", "percentage calculator"] },
  { slug: "business-name-generator", name: "Business Name Generator", description: "Enter your industry or a few keywords and get creative, brandable business name ideas right away.", category: "creator-tools", emoji: "🏢", keywords: ["business name generator", "brand name", "startup name", "company name ideas"] },
  { slug: "study-notes-generator", name: "Study Notes Generator", description: "Paste a topic or text and get clear, structured study notes you can review or export.", category: "utility-tools", emoji: "📚", keywords: ["study notes", "notes generator", "ai notes", "summarize text"] },
  { slug: "website-idea-generator", name: "Website Idea Generator", description: "Describe your interests or niche and get website concepts with suggested names and features.", category: "creator-tools", emoji: "💡", keywords: ["website idea", "website concept", "niche website", "startup idea"] },
  ...
  { slug: "png-to-jpg-converter", name: "PNG to JPG Converter", description: "Drop a PNG and convert it to JPG right in your browser. Pick a quality level and download instantly.", category: "utility-tools", emoji: "🖼️", keywords: ["png to jpg", "image converter", "convert png", "png jpg"] },
  { slug: "favicon-generator", name: "Favicon Generator", description: "Create favicons from text, emoji, colors or an uploaded image and download browser-ready files.", category: "design-tools", emoji: "⭐", keywords: ["favicon generator", "website icon", "favicon maker", "browser icon"] },
  { slug: "svg-blob-generator", name: "SVG Blob Generator", description: "Generate smooth, random SVG blobs for hero sections, backgrounds and creative web layouts.", category: "design-tools", emoji: "🫧", keywords: ["svg blob generator", "blob maker", "organic shapes", "svg shapes"] },
  { slug: "font-pairing-tool", name: "Font Pairing Tool", description: "Find clean font combinations for headings and body text, with ready-to-copy CSS.", category: "design-tools", emoji: "🔤", keywords: ["font pairing", "font combinations", "typography tool", "google fonts"] },
  { slug: "image-placeholder-generator", name: "Image Placeholder Generator", description: "Generate custom image placeholders with your dimensions, colors and label for mockups and layouts.", category: "design-tools", emoji: "🖼️", keywords: ["image placeholder", "placeholder generator", "dummy image", "mockup image"] },
  { slug: "box-shadow-generator", name: "Box Shadow Generator", description: "Design CSS box shadows visually with sliders, then copy the code in one click.", category: "design-tools", emoji: "🌑", keywords: ["box shadow generator", "css shadow", "shadow css", "drop shadow"] },
  { slug: "background-pattern-generator", name: "Background Pattern Generator", description: "Create CSS and SVG background patterns for websites, landing pages and UI mockups.", category: "design-tools", emoji: "▧", keywords: ["background pattern generator", "css patterns", "svg patterns", "dot pattern"] },
];
