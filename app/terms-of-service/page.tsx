    ...
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="space-y-10 rounded-3xl border border-border bg-card p-6 shadow-soft sm:p-10">
        ...
        <section>
          ...
          <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
            <p>
              Sounez grants you a limited, non-exclusive, non-transferable, revocable license to
        ...
        <section>
          ...
          <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
            ...
            <ul className="ml-5 list-disc space-y-1.5">
              ...
              <li>
                Attempting to gain unauthorized access to any part of the website, its servers, or
                related systems.
              </li>
              <li>
        ...
        <section>
          ...
          <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
            ...
            <p>
              Output generated by Sounez tools (such as passwords, QR codes, or color palettes) is
