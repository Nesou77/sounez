    ...
    <>
      ...
      >
        ...
        <p>
          ...
          <a href="/tools/background-pattern-generator">Background Pattern Generator</a> to create and
...
background-size: 48px 48px;`}</code>
        ...
        <p>
          The <a href="/tools/background-pattern-generator">Background Pattern Generator</a> also provides
        ...
        <ol>
          <li>Open the <a href="/tools/background-pattern-generator">Background Pattern Generator</a>.</li>
        ...
        <p>Yes. The <a href="/tools/background-pattern-generator">Sounez Background Pattern Generator</a> is free to use and does not require an account.</p>
        ...
        <p>
          ...
          <a href="/tools/background-pattern-generator">Background Pattern Generator</a>, pick a dot or
          grid pattern, set your brand color at 15-20% opacity, and copy the CSS. Pair it with a
          gradient from the <a href="/tools/css-gradient-generator">CSS Gradient Generator</a> for a
