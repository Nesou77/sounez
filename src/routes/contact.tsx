...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Send feedback, report a bug or request a new tool. The Sounez team replies within 24 hours." },
      { property: "og:title", content: "Contact Sounez" },
      { property: "og:description", content: "Reach the Sounez team — feedback, bugs, partnerships." },
    ],
  }),
  component: Contact,
});
