...
export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Guides, playbooks and tips on growing as a creator, designer and productivity pro." },
      { property: "og:title", content: "Sounez Blog" },
      { property: "og:description", content: "Tips and playbooks for creators." },
    ],
  }),
  component: BlogIndex,
});
